...
<p>Данную документацию было решено сделать для более эффективного обучения данному ремеслу (я руководствуюсь простой логикой - "Обучать - значит вдвойне учиться").</p>
